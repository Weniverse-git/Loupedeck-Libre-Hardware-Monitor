namespace Loupedeck.LHMMonitorPlugin.Commands
{
    ...
    /// <summary>
    /// NVMe #2 온도를 아치형 게이지로 표시합니다.
    /// 게이지 범위 20~100°C. 60°C까지 초록, 76°C까지 노란색, 이상 빨간색.
    /// </summary>
    public class Nvme2TempGaugeCommand : BaseSensorCommand
    {
        ...
        public Nvme2TempGaugeCommand()
            : base("NVMe #2 (Gauge)", "NVMe #2 Temp Gauge View", "Hardware Monitor")
        {
        }
