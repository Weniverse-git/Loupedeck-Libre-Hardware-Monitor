namespace Loupedeck.LHMMonitorPlugin.Commands
{
    ...
    /// <summary>
    /// NVMe #4 온도를 아치형 게이지로 표시합니다.
    /// 게이지 범위 20~100°C. 60°C까지 초록, 76°C까지 노란색, 이상 빨간색.
    /// </summary>
    public class Nvme4TempGaugeCommand : BaseSensorCommand
    {
        ...
        public Nvme4TempGaugeCommand()
            : base("NVMe #4 (Gauge)", "NVMe #4 Temp Gauge View", "Hardware Monitor")
        {
        }
