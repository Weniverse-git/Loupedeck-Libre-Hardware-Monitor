namespace Loupedeck.LLHMPlugin.Commands
{
    ...
    /// <summary>
    /// NVMe #3 온도를 아치형 게이지로 표시합니다.
    /// 게이지 범위 20~100°C. 60°C까지 초록, 76°C까지 노란색, 이상 빨간색.
    /// </summary>
    public class Nvme3TempGaugeCommand : BaseSensorCommand
    {
        ...
        public Nvme3TempGaugeCommand()
            : base("NVMe #3 (Gauge)", "NVMe #3 Temp Gauge View", "Hardware Monitor")
        {
        }
